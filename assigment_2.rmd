...
First we need to compute conditional probability of getting defective products from both factories - these will be our priors
...
# probability of getting defective product from company A
p_A_defect <- defect_A * prior_A / p_defect

# probability of getting defective product from company B
